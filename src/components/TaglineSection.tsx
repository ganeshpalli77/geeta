...
export function TaglineSection() {
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-15 py-6 md:py-8 lg:py-0 bg-[#a83a1b] relative overflow-visible">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-6 md:gap-6 py-6 relative">
        {/* Trophy Image with Circular Background */}
        <div className="relative flex-shrink-0">
          <div
            className="w-40 h-40 sm:w-48 sm:h-48 lg:w-64 lg:h-64 rounded-full bg-[#265a8f] flex items-center justify-center lg:absolute lg:-top-[55%] lg:left-0"
        ...
        <div className="flex-1 text-center px-4">
          <div className="text-white mb-2 font-bold text-4xl">
            Learn, participate, and rise to
          </div>
          <div className="sm:text-5xl md:text-5xl text-5xl text-[#ffca58] font-bold">
